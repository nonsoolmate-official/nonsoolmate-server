...
public record UniversityExamRecordResponseDTO(
    ...
    public static UniversityExamRecordResponseDTO of(final String examName, final String examAnswerUrl, final String examResultUrl) {
        return new UniversityExamRecordResponseDTO(examName, examAnswerUrl, examResultUrl);
    }
}
