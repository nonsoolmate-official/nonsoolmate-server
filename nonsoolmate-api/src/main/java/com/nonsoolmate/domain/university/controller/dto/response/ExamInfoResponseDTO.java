package com.nonsoolmate.domain.university.controller.dto.response;

import io.swagger.v3.oas.annotations.media.Schema;

@Schema(name = "ExamInfoResponseDTO", description = "대학 시험 정보 조회 응답 DTO")
public record ExamInfoResponseDTO(@Schema(description = "시험 id", example = "1") Long examId,
	...
	public static ExamInfoResponseDTO of(final Long examId, final String examName, final int examTimeLimit) {
