...
public record MemberReissueResponseDTO(
    @NotNull @Schema(description = "사용자 id", example = "bcdc8ebd") String memberId,
    @NotNull @Schema(description = "액세스 토큰") String accessToken,
    @NotNull @Schema(description = "리프레시 토큰") String refreshToken) {
  public static MemberReissueResponseDTO of(
      String memberId, String accessToken, String refreshToken) {
