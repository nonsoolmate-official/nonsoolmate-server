...
public record ProfileResponseDTO(
    @Schema(description = "멤버 이름", example = "홍길동") String name,
    @Schema(description = "성별", example = "M") String gender,
    @Schema(description = "태어난 연도", example = "2005") String birthday,
    @Schema(description = "이메일", example = "qwer@gmail.com") String email,
