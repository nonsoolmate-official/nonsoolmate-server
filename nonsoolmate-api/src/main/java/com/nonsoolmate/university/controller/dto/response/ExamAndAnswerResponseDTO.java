...
public record ExamAndAnswerResponseDTO(
		@Schema(description = "시험 이름(대학 + 시험 년도 + 시험 이름)", example = "2023 중앙대학교 경영경제 1")
				String examName,
		@Schema(description = "시험 문제 PDF URL") String examUrl,
		@Schema(description = "이미지 해제 PDF URL") String examAnswerUrl) {
	public static ExamAndAnswerResponseDTO of(
			final String examName, final String examUrl, final String examAnswerUrl) {
