...
public record SelectCollegeExamsResponseDTO(
  ...
  public static SelectCollegeExamsResponseDTO of(
      final College college, final List<SelectCollegeExamResponseDTO> examList) {
    return new SelectCollegeExamsResponseDTO(
